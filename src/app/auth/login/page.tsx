      ...
      <div className="pt-24 min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <h1 className="text-2xl font-bold text-green-800 text-center mb-2">登录</h1>
            ...
            <button className="w-full border border-gray-200 hover:bg-gray-50 text-gray-700 py-3 rounded-xl font-medium transition flex items-center justify-center gap-2">
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              还没有账号？
              <Link href="/auth/register" className="text-green-500 hover:text-green-600 font-medium ml-1">
                去注册
              </Link>
            </p>
          </div>
